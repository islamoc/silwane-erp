...
// Read bcrypt rounds from env (P1 fix: no more hardcoded 10)
 ...
 */
router.get('/', authenticate, authorizeRoles('super_admin', 'admin'), async (req, res, next) => {
  try {
 ...
 * @access  Private (admin / super_admin)
 */
router.get('/:id', authenticate, authorizeRoles('super_admin', 'admin'), async (req, res, next) => {
  try {
 ...
 * @access  Private (admin / super_admin)
 */
router.post('/', authenticate, authorizeRoles('super_admin', 'admin'), async (req, res, next) => {
  try {
 ...
 * @access  Private (admin / super_admin)
 */
router.put('/:id', authenticate, authorizeRoles('super_admin', 'admin'), async (req, res, next) => {
  try {
 ...
 */
router.delete('/:id', authenticate, authorizeRoles('super_admin'), async (req, res, next) => {
  try {
